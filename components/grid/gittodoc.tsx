...
export default function GitToDoc() {
    const projectName = 'GitToDoc';

    return (
        <Card className='group relative bg-gradient-to-br from-purple-100 to-blue-100 dark:from-purple-900/20 dark:to-blue-900/20'>
            <Image
                src='/projects/gittodoc/gittodoc 1.png'
