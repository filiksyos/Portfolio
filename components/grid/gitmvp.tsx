...
export default function GitMVP() {
    const projectName = 'GitMVP';

    return (
        <Card className='group relative bg-gradient-to-br from-indigo-100 to-purple-100 dark:from-indigo-900/20 dark:to-purple-900/20'>
            <Image
                src='/projects/gitmvp/gitmvp 1.png'
